...
- [>] T1 Covering-test execution out of process (depends: S1, S2, H1) (2026-07-08: all preconditions confirmed - covering-selection entry points, Microsoft.Testing.Platform cached, and the emit spike passes (a rehydrated resident compilation emits a runnable assembly); the micro-host runner implementation is the fresh-session shipped work)
