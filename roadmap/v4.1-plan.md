...
- [>] S1 The resident workspace: compilation as source of truth (depends: X1) (2026-07-08: preconditions + architecture recorded; sub-step 1 landed - new Fuse.Workspace library with ResidentWorkspace rehydration-to-resident loader, gate-green; steps 2-6 pending)
