...
- [>] S4 Analyzer and nullable parity in check (depends: S1, S2) (2026-07-08: preconditions partly recorded by code inspection; empirical capture inspection + analyzer cost spike remain as the item's opening steps before edits)
