...
base is available, change review below reaches 100 percent changed-file recall at 93.4
percent precision in a median 1,026 tokens.
...
mode by measurement: over 69 real merged pull requests, change review keeps 100 percent
of changed files at 93.4 percent precision in a median 1,026 returned tokens
...
[The iterative workflow](/docs/concepts/iterative-workflow) for how an agent uses it across
