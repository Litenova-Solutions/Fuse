...
See [The iterative workflow](/docs/concepts/iterative-workflow) for how an agent uses
scoping across a task. Or put a mode to work: [Scope a pull request](/docs/scenarios/scope-a-pr)
or [Ask one question](/docs/scenarios/ask-one-question).
