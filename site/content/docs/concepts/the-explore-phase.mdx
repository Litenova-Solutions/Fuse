...
`fuse --query` call delivers about 43,000 tokens at 55 percent recall of the changed
...
511,574 tokens, Fuse ties on round-trips and wins on tokens, roughly 11.9 times fewer,
