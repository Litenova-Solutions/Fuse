...
`fuse --query` call delivers about 40,000 tokens at 61 percent recall of the changed
files, and the change-scoping mode reaches 87 percent recall when a git base is available.
