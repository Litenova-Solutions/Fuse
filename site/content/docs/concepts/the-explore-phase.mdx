...
`fuse --query` call delivers about 42,000 tokens at 57 percent recall of the changed
...
511,574 tokens, Fuse ties on round-trips and wins on tokens, roughly 12.1 times fewer,
