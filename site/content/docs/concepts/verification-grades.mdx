...
- **oracle** - a speculative typecheck against the tier-1 build-captured compilation. The
  ...
  repository builds and is captured at tier-1. Tier-1 is on by default: the out-of-process
