...
|----------|--------------------|----------------------------|
| `DiRegistrationAnalyzer` | `Microsoft.Extensions.DependencyInjection` registrations (`AddScoped`, `AddSingleton`, `AddTransient`, `TryAdd*`, open generics, factory lambdas, Scrutor scanning and decoration) | `di_resolves_to` (service to implementation) and DI registration records |
