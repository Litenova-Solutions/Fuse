...
- Full-text: the query tokens are matched against the FTS5 index over chunk path, name, declared symbols, signature, comments, and body, with column weights that favor names and signatures over body text.
