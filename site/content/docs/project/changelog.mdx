...
**Unreleased / 4.2 (planned):** index store split, semantic provider seam, scoping unification, CI `RequiresSdk` leg, briefing cleanup, unified API surface doc, host IPC and hook ergonomics. See the [Roadmap](/docs/project/roadmap) and `roadmap/v4.2-plan.md` in the repository.
