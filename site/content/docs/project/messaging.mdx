...
- .NET wiring resolution (Suite A, `semantics.json`): the extracted graph matches the hand-built edge ground truth exactly on the wiring fixture (23 of 23 edges, recall and precision 1.0).
