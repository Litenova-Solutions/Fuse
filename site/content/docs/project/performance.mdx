...
| Localize (`fuse_find` kind=task) | 42 ms | 55 ms | 2.6 ms | 4.2 ms |
| Resolve symbol (`fuse_find` kind=service) | ~0 ms | 0.1 ms | ~0 ms | ~0 ms |
| Review plan (`fuse_review`) | 117 ms | not recorded | 38.3 ms | 41.6 ms |
| Single-file incremental re-index | 24 ms | not recorded | 1.9 ms | 2.3 ms |
...
|------------------|----:|----:|------|
| Delta check, analyzers off (speculative typecheck) | 19.9 ms | 31.0 ms | P95 < 1000 ms: PASS |
