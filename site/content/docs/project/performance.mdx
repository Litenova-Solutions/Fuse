...
The analyzer timing measures raw analyzer execution against the held compilation. It does not measure editorconfig severity mapping or establish full CI parity. The resident workspace warms once (build plus rehydrate) at 14,092 ms and holds the compilations at 162 MB RSS for the NodaTime checkout.
