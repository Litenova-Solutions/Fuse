...
| `fuse mcp install` | Nothing; registers Fuse with MCP clients | Not applicable | Not applicable | `--client`, `--scope`, `--command` |
...
for every project on this machine. Use `--command` to override the executable the client
