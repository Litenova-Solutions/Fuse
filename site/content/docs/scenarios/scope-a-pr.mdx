...
files always kept. Change scoping is the strongest mode by measurement: over 69 real merged pull requests,
`fuse review` keeps 100 percent of changed files at 93.4 percent precision in a median
1,026 returned tokens ([benchmarks](/docs/project/benchmarks)). It is one call, not an
explore loop.
