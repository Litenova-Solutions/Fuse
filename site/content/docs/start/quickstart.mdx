...
The first call builds `.fuse/fuse.db`. A large repository can take from a few seconds to
tens of seconds on this cold call. Later calls reuse the local index.
