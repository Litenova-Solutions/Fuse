---
title: What is Fuse
description: Fuse helps an existing coding agent check C# edits, follow .NET application wiring, and gather focused branch context from the local repository.
---

Fuse helps your coding agent catch a C# compiler error before it changes the file. Install
and connect it from a .NET project directory:
...
Fuse works with the coding agent you already use. It runs on your machine and gives that
agent compiler-backed results plus a typed map of the application.
