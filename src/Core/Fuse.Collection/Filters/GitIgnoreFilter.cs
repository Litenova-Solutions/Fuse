...
public sealed class GitIgnoreFilter : IFileFilter
{
    ...
    /// <remarks>
    ///     <see cref="FileCollectionPipeline" /> calls this before evaluating candidates so that
    ///     <see cref="Include" /> matches against the patterns gathered for the current source tree.
