...
/// <summary>
///     Detects ASP.NET controller actions and minimal-API route registrations.
/// </summary>
public sealed class CSharpRouteMapGenerator : Fuse.Languages.Abstractions.Maps.IRouteMapGenerator
{
