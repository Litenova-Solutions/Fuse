...
/// <summary>
///     Fuse project configuration loaded from <c>fuse.json</c> or <c>.fuserc</c>. A <see langword="null" />
///     property means the value was not specified and the CLI flag or built-in default applies.
/// </summary>
/// <remarks>
///     Deserialized by <see cref="FuseConfigLoader" /> and merged with CLI options, where explicit flags win
///     over config values.
/// </remarks>
public sealed class FuseConfig
{
    ...
    /// <summary>Output format: <c>xml</c>, <c>markdown</c>, or <c>json</c>.</summary>
