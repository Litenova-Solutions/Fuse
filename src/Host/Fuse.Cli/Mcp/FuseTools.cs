...
///     <c>fuse_resolve</c>). The ten tools (index, map, localize, resolve, context, review, find, neighbors,
///     signatures, reduce) work over the persistent semantic index; read tools build the index on first use.
