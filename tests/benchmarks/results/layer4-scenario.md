...
| Fuse (--query) | 1 | 43,165 | 55% |

## Per repo (headline budget)

| Repo | no-fuse K (>=) | no-fuse rel tok | whole-repo tok | Repomix tok | Fuse tok | Fuse recall |
|------|---------------:|----------------:|---------------:|------------:|---------:|------------:|
| AutoMapper | 2.3 | 3,342 | 456,599 | 473,904 | 47,708 | 38% |
| FluentValidation | 3.5 | 5,711 | 256,538 | 268,083 | 43,965 | 57% |
| MediatR | 2.7 | 3,326 | 79,282 | 84,894 | 32,225 | 94% |
| NewtonsoftJson | 14.5 | 97,514 | 1,182,224 | 1,219,416 | 48,763 | 32% |
